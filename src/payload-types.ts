...
export interface Tenant {
  ...
  name: string;
  /**
   * This is subdomain for the store. eg. [slug].example.com
   */
  slug: string;
  ...
  /**
   * You cannot create products or process payments until you have submitted your details to Stripe.
   */
...
export interface Product {
  ...
  /**
   * If checked, this product will be private
   */
