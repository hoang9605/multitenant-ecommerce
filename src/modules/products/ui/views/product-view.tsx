                        ...
                        <div className="border-t lg:border-t-0 lg:border-l h-full border-black">
                            <div className="flex flex-col gap-4 p-6 border-b border-black">
                                <div className="flex flex-row items-center gap-2">
                                    ...
                                    />
                                    <Button
                                        className="size-12 hover:bg-black hover:text-white"
                                        variant="outline"
                                        onClick={() => {
                                            setIsCopied(true);
                                            navigator.clipboard.writeText(window.location.href);
                                            toast.success("URL copied to clipboard", {className: "border border-black"});
                                    ...
                                    {[5, 4 ,3, 2, 1].map((stars) => (
                                        <Fragment key={stars}>
                                            ...
                                            <Progress 
                                                ...
                                                className="h-[1lh] border-black border"
                                            />
